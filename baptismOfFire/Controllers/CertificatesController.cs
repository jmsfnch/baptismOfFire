...
namespace baptismOfFire.Controllers
{
    public class CertificatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CN,ExpiresDate")] Certificate certificate)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,CN,ExpiresDate")] Certificate certificate)
        {
            if (ModelState.IsValid)
            {
